// Site data for Nicholas Pellizer's portfolio
  ...
  podcasts: [
    {
      ...
      description: "about Trieste",
    },
    {
      name: "Decadi",
      url: "https://decadi.it",
      description: "exploring generational differences",
    },
  ],
};
...
export const skills = [
  {
    category: "Backend",
    items: ["Node.js", "TypeScript", ".NET Core", "C#", "SQL Server"],
  },
  {
    category: "Frontend",
  ...
  {
    category: "Other",
    items: ["Team Leadership", "Project Management", "Technical Analysis"],
  },
];
